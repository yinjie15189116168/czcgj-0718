...
public abstract class Credential {
	...
	public String toString() {
		return "Credential [grantType=" + grantType + ", tokenKey1="
				+ tokenKey1 + ", tokenKey2=" + tokenKey2 + ", token=" + token
				+ "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((tokenKey1 == null) ? 0 : tokenKey1.hashCode());
		result = prime * result
				+ ((tokenKey2 == null) ? 0 : tokenKey2.hashCode());
		return result;
	}
