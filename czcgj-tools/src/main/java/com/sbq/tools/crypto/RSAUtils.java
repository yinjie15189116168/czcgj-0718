...
public final class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥密文:" + new String(mi, Constants.UTF_8));

        //解密后的明文
        ming = RSAUtils.decryptByPrivateKey(mi, privateKey);
        System.out.println("私钥解密:" + new String(ming, Constants.UTF_8));

        System.out.println("==============");

        mi = RSAUtils.encryptByPrivateKey(ming, RSAUtils.encodeBase64(privateKey));
        System.out.println("私钥密文:" + new String(mi, Constants.UTF_8));

        ming = RSAUtils.decryptByPublicKey(mi, RSAUtils.encodeBase64(publicKey));
        System.out.println("公钥解密:" + new String(ming, Constants.UTF_8));
    }
}