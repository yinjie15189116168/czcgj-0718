...
public class XingeApp {
    ...
    public static String XINGE_HOST = "http://openapi.xg.qq.com";
    ...
    static {
        ...
        try {
            ...
            String host = propertiesUtil.getString("xinge.host");
    ...
    public static final String RESTAPI_PUSHSINGLEDEVICE = XINGE_HOST + "/v2/push/single_device";
    public static final String RESTAPI_PUSHSINGLEACCOUNT = XINGE_HOST + "/v2/push/single_account";
    public static final String RESTAPI_PUSHACCOUNTLIST = XINGE_HOST + "/v2/push/account_list";
    public static final String RESTAPI_PUSHALLDEVICE = XINGE_HOST + "/v2/push/all_device";
    public static final String RESTAPI_PUSHTAGS = XINGE_HOST + "/v2/push/tags_device";
    public static final String RESTAPI_QUERYPUSHSTATUS = XINGE_HOST + "/v2/push/get_msg_status";
    public static final String RESTAPI_QUERYDEVICECOUNT = XINGE_HOST + "/v2/application/get_app_device_num";
    public static final String RESTAPI_QUERYTAGS = XINGE_HOST + "/v2/tags/query_app_tags";
    public static final String RESTAPI_CANCELTIMINGPUSH = XINGE_HOST + "/v2/push/cancel_timing_task";
    public static final String RESTAPI_BATCHSETTAG = XINGE_HOST + "/v2/tags/batch_set";
    public static final String RESTAPI_BATCHDELTAG = XINGE_HOST + "/v2/tags/batch_del";
    public static final String RESTAPI_QUERYTOKENTAGS = XINGE_HOST + "/v2/tags/query_token_tags";
    public static final String RESTAPI_QUERYTAGTOKENNUM = XINGE_HOST + "/v2/tags/query_tag_token_num";
    public static final String RESTAPI_CREATEMULTIPUSH = XINGE_HOST + "/v2/push/create_multipush";
    public static final String RESTAPI_PUSHACCOUNTLISTMULTIPLE = XINGE_HOST + "/v2/push/account_list_multiple";
    public static final String RESTAPI_PUSHDEVICELISTMULTIPLE = XINGE_HOST + "/v2/push/device_list_multiple";
    public static final String RESTAPI_QUERYINFOOFTOKEN = XINGE_HOST + "/v2/application/get_app_token_info";
    public static final String RESTAPI_QUERYTOKENSOFACCOUNT = XINGE_HOST + "/v2/application/get_app_account_tokens";
    public static final String RESTAPI_DELETETOKENOFACCOUNT = XINGE_HOST + "/v2/application/del_app_account_tokens";
    public static final String RESTAPI_DELETEALLTOKENSOFACCOUNT = XINGE_HOST + "/v2/application/del_app_account_all_tokens";
    ...
    public JSONObject pushSingleDevice(String deviceToken, Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/single_device", params);
    }
    ...
    public JSONObject pushSingleAccount(int deviceType, String account, Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/single_account", params);
    }
    ...
    public JSONObject pushAccountList(int deviceType, List<String> accountList, Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/account_list", params);
    }
    ...
    public JSONObject pushAllDevice(int deviceType, Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/all_device", params);
    }
    ...
    public JSONObject pushTags(int deviceType, List<String> tagList, String tagOp, Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/tags_device", params);
    }
    ...
    public JSONObject createMultipush(Message message) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/create_multipush", params);
    }
    ...
    public JSONObject pushAccountListMultiple(long pushId, List<String> accountList) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/account_list_multiple", params);
    }
    ...
    public JSONObject pushDeviceListMultiple(long pushId, List<String> deviceList) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/device_list_multiple", params);
    }
    ...
    public JSONObject queryPushStatus(List<String> pushIdList) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/get_msg_status", params);
    }
    ...
    public JSONObject queryDeviceCount() {
        ...
        return callRestful(XINGE_HOST + "/v2/application/get_app_device_num", params);
    }
    ...
    public JSONObject queryTags(int start, int limit) {
        ...
        return callRestful(XINGE_HOST + "/v2/tags/query_app_tags", params);
    }
    ...
    public JSONObject queryTagTokenNum(String tag) {
        ...
        return callRestful(XINGE_HOST + "/v2/tags/query_tag_token_num", params);
    }
    ...
    public JSONObject queryTokenTags(String deviceToken) {
        ...
        return callRestful(XINGE_HOST + "/v2/tags/query_token_tags", params);
    }
    ...
    public JSONObject cancelTimingPush(String pushId) {
        ...
        return callRestful(XINGE_HOST + "/v2/push/cancel_timing_task", params);
    }
    ...
    public JSONObject BatchSetTag(List<TagTokenPair> tagTokenPairs) {
        ...
        List<List> tag_token_list = new ArrayList();
        for (TagTokenPair pair : tagTokenPairs) {
            List<String> singleTagToken = new ArrayList();
        ...
        return callRestful(XINGE_HOST + "/v2/tags/batch_set", params);
    }
    ...
    public JSONObject BatchDelTag(List<TagTokenPair> tagTokenPairs) {
        ...
        return callRestful(XINGE_HOST + "/v2/tags/batch_del", params);
    }
    ...
    public JSONObject queryInfoOfToken(String deviceToken) {
        ...
        return callRestful(XINGE_HOST + "/v2/application/get_app_token_info", params);
    }
    ...
    public JSONObject queryTokensOfAccount(String account) {
        ...
        return callRestful(XINGE_HOST + "/v2/application/get_app_account_tokens", params);
    }
    ...
    public JSONObject deleteTokenOfAccount(String account, String deviceToken) {
        ...
        return callRestful(XINGE_HOST + "/v2/application/del_app_account_tokens", params);
    }
    ...
    public JSONObject deleteAllTokensOfAccount(String account) {
        ...
        return callRestful(XINGE_HOST + "/v2/application/del_app_account_all_tokens", params);
    }
}
