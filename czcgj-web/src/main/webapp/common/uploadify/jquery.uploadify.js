...
/*
 * SWFUpload.prototype.getFlashHTML = function() { return [ '<object id="',
 * this.movieName, '" type="application/x-shockwave-flash" data="',
 * this.settings.flash_url, '" width="', this.settings.button_width, '"
 * height="', this.settings.button_height, '" class="swfupload">', '<param
 * name="wmode" value="', this.settings.button_window_mode, '" />', '<param
 * name="movie" value="', this.settings.flash_url, '" />', '<param
 * name="quality" value="high" />', '<param name="menu" value="false" />', '<param
 * name="allowScriptAccess" value="always" />', '<param name="flashvars"
 * value="' + this.getFlashVars() + '" />', "</object>" ].join("") };
 */
