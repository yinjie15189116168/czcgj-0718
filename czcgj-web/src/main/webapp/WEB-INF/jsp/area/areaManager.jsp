    ...
    <div class="main-div">
        <div class="center-Panel" style="overflow-x: hidden">
            <div class="titlePanel">
                <div class="title-search">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="pull-right search">
                                    <input class="form-control" type="text" placeholder="搜索" id="leader_name"></div>
                            </td>
                ...
                <div class="toolbar">
                    <div class="btn-group">
                        <a class="btn btn-default lr-add" onclick="addArea()"><i class="fa fa-plus"></i>&nbsp;新增</a>
                    </div>
                </div>
            </div>
            <div>
...
<script src="${ctx}/module/area/scripts/areaManager.js?v=<%=System.currentTimeMillis()%>"></script>
</body>
</html>
