...
<body ng-controller="deviceAddController">
<div class="submenu"
    ...
    <div class="main-div">
        <table>
            ...
            <tr>
                ...
                <td class="labeltd" style="text-align:left;"><input
                        id="serious_warn_angle" ng-model="serious_warn_angle" placeholder="例如:10,默认10"
                        class="form-control"/>
                </td>
                <td class="labeltd"><label class="control-label">严重告警上报周期(分)</label>
                </td>
                <td class="labeltd" style="text-align:left;"><input
                        id="serious_warn_period" ng-model="serious_warn_period" placeholder="例如:5,默认5"
                        class="form-control"/>
                </td>
            </tr>
            <tr style="height:41px;" class="labeltr">
...
<script type="text/javascript"
        src="${ctx }/module/device/scripts/addDevice.js?v=<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
