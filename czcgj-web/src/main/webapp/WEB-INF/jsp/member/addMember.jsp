...
<body ng-controller="memberAddController">
<div class="submenu" id="addMember"
    ...
    <div class="main-div">
        <table>
            ...
            <tr style="height:41px;" class="labeltr">
                ...
                <td class="labeltd" style="text-align:left;"><input
                        ng-model="mobile" class="form-control"/>
                </td>
            </tr>
            <tr style="height:41px;" class="labeltr">
                ...
                <td class="labeltd" style="text-align:left;"><input
                        ng-model="tel" class="form-control"/>
                </td>
            </tr>
...
<script type="text/javascript"
        src="${ctx }/module/member/scripts/addMember.js?v=<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
