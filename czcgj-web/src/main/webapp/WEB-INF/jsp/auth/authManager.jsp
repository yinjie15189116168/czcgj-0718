    ...
    <div class="main-div">
        <div class="center-Panel" style="overflow-x: hidden">
            <div class="titlePanel">
                ...
                <div class="toolbar">
                    <div class="btn-group">
                        <a class="btn btn-default lr-add" onclick="addAuth()"><i class="fa fa-plus"></i>&nbsp;新增</a>
                    </div>
                </div>
            </div>
            <div>
...
<script src="${ctx}/module/auth/scripts/authManager.js?v=<%=System.currentTimeMillis()%>"></script>
</body>
</html>
