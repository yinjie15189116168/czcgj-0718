...
(function($){
   ...
   function returnFmenu()
   {
      ...
      html += '<li><a id="extWebApp" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.msg_74+'><i class="appbox appbox_icons">&#xe67a;</i> '+td_lang.inc.msg_74+'</a></li>';//"������Ӧ��"
      html += '<li><a id="extFav" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.personfav+'><i class="fav appbox_icons">&#xe679;</i> '+td_lang.inc.personfav+'</a></li>';//"�����ղ�"
      return html;
   }
