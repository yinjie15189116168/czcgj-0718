 ...
 */
//调用jsonp函数请求当前所在城市
jsonp('https://api.map.baidu.com/api?v=2.0&ak=Dxwdb4m56dSlOkE67ZQgtFGD&s=1&callback=getCity');
...
function changeImg(data) {
    console.log(data)
    var firstImg = document.getElementsByTagName("img")[10];
...
function chooseImg(id, index) {
    switch (id) {
        case '1':
            index.src = contextpath + '/module/img/1.png';
            break;
        case '2':
            index.src = contextpath + '/module/img/2.png';
            break;
        case '3':
            index.src = contextpath + '/module/img/3.png';
            break;
        case '4':
        case '5':
        case '6':
        ...
        case '25':
        case '26':
            index.src = contextpath + '/module/img/4.png';
            break;
        case '7':
            index.src = contextpath + '/module/img/6.png';
            break;
        case '14':
        case '15':
        case '16':
        ...
        case '28':
        case '29':
            index.src = contextpath + '/module/img/5.png';
            break;
        case '19':
        case '21':
        case '30':
        ...
        case '32':
        case '33':
            index.src = contextpath + '/module/img/7.png';
            break;
        default:
            index.src = contextpath + '/module/img/8.png';
    }
}
...
function createUrl() {
    ...
    var urls = [];
    urls[0] = 'https://sapi.k780.com/?app=weather.future&appkey=10003&sign=b59bc3ef6191eb9f747dd4e83c99f2a4&format=json&jsoncallback=getWeather&weaid=' + encodeURI('常州');
    urls[1] = 'https://api.map.baidu.com/telematics/v3/weather?output=json&ak=FK9mkfdQsloEngodbFl4FeY3&callback=getTodayWeather&location=' + encodeURI('常州');
    return urls;
}